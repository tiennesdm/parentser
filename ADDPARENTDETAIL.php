...
<fieldset class="field">
  <legend><B>SET THE INFORMATION ABOUT STUDENT PARENTS</B></legend>
  <center>
      <form method="post" action="insertparentdetail.php">
<table>
<tr><td>Name:</td>
...
<tr>
    <td>FATHER'S NAME</td>
    <td><input type="text"  class="set" name="father" required="required"></td>
</tr>

<tr><td>USERNAME</td>
    <td><input type="text"  class="set" name="username" required="required"></td></tr>
...
<tr><td></td><td><button class="set">SUBMIT</button></td></tr>
</table>
</form>
  </center>      
</fieldset>
