...
<fieldset class="field">
  ...
  <center>
      <form method="post" action="addstudentmarks.php">
<table>
<tr><td>Name:</td>
...
<td><input type="text" name="totalmarks" class="set" required="required"></td></tr>

<tr><td>MARKS OBTAINED:</td>
<td><input type="text" name="obtainmarks" class="set" required="required"></td></tr>
<tr><td>TEST </td>
    <td><select class="set" name="testno" required="required">
