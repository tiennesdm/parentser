...
<fieldset class="field">
  ...
  <center>
      <form method="post" action="insertreapperbyteacher.php">
<table>
<tr><td>Name:</td>
...
<tr><td>SUBJECT:</td>
    <td><select class="set" name="subject" required="required">
<OPTION>MPI</OPTION>
<OPTION>MMT</OPTION>
<OPTION>POS</OPTION>
<OPTION>WD</OPTION>
...
<tr><td>TOTAL RE:</td>
    <td><input type="number" name="reappear" class="set" required="required">
</td>
